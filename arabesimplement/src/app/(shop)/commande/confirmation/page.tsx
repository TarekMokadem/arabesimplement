      ...
      <div className="max-w-2xl mx-auto px-6 py-8">
        ...
        <Card className="bg-white text-center">
          <CardContent className="p-12">
            {/* Success Icon */}
            <div className="w-20 h-20 bg-[#1A7A4A]/10 rounded-full flex items-center justify-center mx-auto mb-6">
              <CheckCircle className="h-10 w-10 text-[#1A7A4A]" />
            </div>

            <h1 className="font-serif text-3xl font-bold text-[#0F2A45] mb-4">
            ...
            {/* Next Steps */}
            <div className="bg-[#F9F7F2] rounded-xl p-6 text-left mb-8">
              <h2 className="font-serif font-bold text-[#0F2A45] mb-4">
                Prochaines étapes
              </h2>
            ...
            <div className="mb-8">
              <p
                className="font-arabic text-2xl text-[#B7860B] mb-2"
                dir="rtl"
              >
                بارك الله فيكم
              </p>
